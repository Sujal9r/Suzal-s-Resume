    ...
    <Section id="about" title="About Me" subtitle="A bit about who I am and what I do.">
      <div className="grid md:grid-cols-2 gap-8">
        <motion.p className="text-white/80 leading-relaxed" data-aos="fade-right">
          I’m Sujal Sharma — a MERN stack and front-end developer who loves crafting clean, accessible, and interactive UIs. I build modern, responsive web apps with React, Node.js, Express, and MongoDB, focusing on smooth UX, motion, and mobile-first design.
        </motion.p>
